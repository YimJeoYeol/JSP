...
<%@ page import="java.util.*"%>
    ...
    try {
    	...
    	if(result > 0){
			System.out.print(result); //어떤 값이 반환했는지 확인하려고 찍어봄.
			System.out.print("데이터가 성공적으로 입력되었습니다.<br>");
    	} else {
			System.out.print(result); //어떤 값이 반환했는지 확인하려고 찍어봄.
    		System.out.print("데이터 저장에 실패했습니다.<br>");
    	}
    	...
    	if(result > 0){
			System.out.print("<br>데이터가 성공적으로 입력되었습니다.<br>");
    	} else {
			System.out.print("<br>데이터 저장에 실패했습니다.<br>");
    	}
    	try {
